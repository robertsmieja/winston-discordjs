...
## 2024-05-25 - toLocaleUpperCase() overhead in hot paths
**Learning:** `toLocaleUpperCase()` has significant performance overhead (~14x slower) compared to `toUpperCase()` in Node.js/V8 due to locale-awareness. In hot paths like logging or string formatting, this overhead accumulates quickly.
