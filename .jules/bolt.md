...
## 2026-07-03 - Avoid toLocaleUpperCase in hot paths
**Learning:** `toLocaleUpperCase()` has significant performance overhead (~10-15x slower) compared to `toUpperCase()` in Node.js/V8 due to locale-awareness. In hot paths like logging pipelines, this creates unnecessary CPU overhead.
