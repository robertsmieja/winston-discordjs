...
// toUpperCase is used over toLocaleUpperCase for a ~75% performance improvement in hot paths
const capitalize = (str: string): string =>
  str.charAt(0).toUpperCase() + str.slice(1)

const safeStringify = (value: any): string => {
  // Early return for string primitives bypasses the try-catch and String() coercion overhead,
  // providing a ~2x performance improvement for hot paths like logging.
