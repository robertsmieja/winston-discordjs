...
const capitalize = (str: string): string =>
  // Use toUpperCase() instead of toLocaleUpperCase() to avoid locale overhead (~4-15x faster)
  str.charAt(0).toUpperCase() + str.slice(1)

const safeStringify = (value: any): string => {
  // Early return for strings to skip try/catch and String() wrapper overhead
