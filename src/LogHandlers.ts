...
// Use toUpperCase instead of toLocaleUpperCase for ~90% performance improvement in execution time
const capitalize = (str: string): string =>
  str.charAt(0).toUpperCase() + str.slice(1)

const safeStringify = (value: any): string => {
  // Early return for string primitives to bypass conversion overhead
